...
test.describe('Home Page', () => {
  test('should display the hero section', async ({ page }) => {
    ...
    await expect(page.getByRole('heading', { name: /LinkedIn Carousels erstellen/i })).toBeVisible()
  ...
  test('should display features section', async ({ page }) => {
    ...
    await expect(page.getByRole('heading', { name: /Alles was du brauchst/i })).toBeVisible()
